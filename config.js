// config.js - Конфигурация всех AI движков v2.0
...
const engines = {
  ...
  'firefly': {
    ...
    icon: '🖼️',
    category: 'image',
    description: 'Коммерческое использование, интеграция с Adobe',
    enhancementRules: [
  ...
  'nanobanana': {
    ...
    icon: '🖼️',
    category: 'image',
    description: 'Генерация изображений через Google Gemini',
    enhancementRules: [
  ...
  'flux': {
    ...
    icon: '🖼️',
    category: 'image',
    description: 'Реалистичные изображения, высокая детализация',
    enhancementRules: [
  ...
  'soul': {
    ...
    icon: '🖼️',
    category: 'image',
    description: 'Гиперреалистичные фото, мода, портреты',
    enhancementRules: [
  ...
  'sora2': {
    ...
    category: 'video',
    maxLength: 'до 60 sec',
    description: 'OpenAI видео генерация, высокая связность',
    enhancementRules: [
